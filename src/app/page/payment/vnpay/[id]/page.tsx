...
export default function VnpayPage() {
  ...
  useEffect(() => {
    if (id) {
      fetch(`https://fiyo-be.onrender.com/api/orderDetail/${id}`)
        .then((res) => res.json())
        .then((data) => {
          if (data.status) {
  ...
  const handleVnpayPayment = async () => {
    ...
    try {
      const res = await fetch('https://fiyo-be.onrender.com/api/orders/vnpay', {
          method: 'POST',
...
//           }
//         })
//         .catch(() => setError('Lỗi lấy đơn hàng.'));
//     }
//   }, [id]);
...
//   // ✅ CHỈ yêu cầu URL thanh toán cho ĐƠN ĐÃ CÓ (idempotent, không tạo đơn mới)
//   const handleVnpayPayment = async () => {
//     if (loading) return;
//     if (!products.length) return;

//     // order_id của đơn CHA đã được tạo ở bước Checkout
...
//     try {
//       const res = await fetch(`https://fiyo-be.onrender.com/api/orders/${orderId}/vnpay`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         // chỉ truyền locale nếu cần; KHÔNG truyền products / address / total nữa
...
//           <header className="checkout-header checkout-header--vnpay">
//             <div className="checkout-header__container">
//               <div className="checkout-header__title">Thanh toán qua cổng VNPAY</div>
//             </div>
//           </header>
...
//                 <li>
//                   <label>Thanh toán</label>
//                   <div className="value">Thẻ ATM/Visa/Master/JCB/QR Pay qua cổng VNPAY</div>
//                 </li>
//                 <li>
//                   <label>Tổng tiền</label>
//                   <div className="value"><b>{total.toLocaleString()} ₫</b></div>
...
//                     <div className="checkout-success__product-detail">
//                       <div className="checkout-success__product-info">
//                         <div className="checkout-success__product-name">{item.product.name}</div>
//                         <div className="checkout-success__product-sku">{item.product.size?.sku}</div>
//                         <div className="checkout-success__product-options">
//                           <div className="checkout-success__product-option">
//                             <span
//                               className="checkout-success__product-option--color"
...
//                         </div>
//                       </div>
//                       <div className="checkout-success__product-qty">SL: {item.quantity}</div>
//                     </div>
//                   </div>
//                 ))}
//               </div>
