...
export default function ProductSection() {
  ...
  try {
    ...
    const allProducts = activeCategory
      ...
      : await getAllProBestSelling("https://fiyo-be.onrender.com/api/products");
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        const category = await getAllCategory("https://fiyo-be.onrender.com/api/category/parents");
